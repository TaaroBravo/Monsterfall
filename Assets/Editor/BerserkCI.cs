...
[CustomEditor(typeof(Berserk))]

public class BerserkCI : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (EditorGUILayout.BeginFadeGroup(fadeVariablesHabilities.faded))
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Stomp");
            player.power = EditorGUILayout.FloatField("Poder del Stomp", player.power);
            player.stompCooldown = EditorGUILayout.FloatField("Cooldown del Stomp", player.stompCooldown);
            EditorGUILayout.Space();
            EditorGUILayout.LabelField("Charge");
            player.chargeSpeed = EditorGUILayout.FloatField("Velocidad del Charge", player.chargeSpeed);
            player.chargeCooldown = EditorGUILayout.FloatField("Cooldown del Charge", player.chargeCooldown);
            EditorGUILayout.Space();
        }
        EditorGUILayout.EndFadeGroup();
